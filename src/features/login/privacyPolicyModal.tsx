        ...
        <StyledView className="bg-white p-4 rounded-lg max-h-[50vh] w-full">
          ...
          <StyledScrollView>
            <StyledView className="space-y-4">
              ...
              <StyledText className="text-base">NowMatchは、サービスの提供および改善のため、ユーザーの個人情報（名前、年齢、メールアドレスまたは電話番号、プロフィール写真、地理的な位置情報）を収集します。</StyledText>
              <StyledText className="text-base">アプリ内でのアクティビティデータ（メッセージや通話の履歴、購買情報）およびGPS位置情報も収集し、サービス向上やパーソナライズに役立てます。</StyledText>
              <StyledText className="text-base">NowMatchは、デバイス情報（IPアドレス、広告ID、アプリのクラッシュデータ）や使用状況データ（ログイン日時、通知履歴）を自動的に収集します。</StyledText>

              <StyledText className="font-bold text-lg">データの利用目的:</StyledText>
              <StyledText className="text-base">• ユーザーアカウントの作成、管理、削除。</StyledText>
              <StyledText className="text-base">• メッセージ、ボイスメッセージ、ビデオ通話の管理および提供。</StyledText>
              <StyledText className="text-base">• プロフィール認証を行い、ユーザーの安全性を確保（バイオメトリクスデータや動画での顔認証を含む）。</StyledText>
              <StyledText className="text-base">• ユーザーが交差した他のメンバーの提案とそのプロフィールの表示。</StyledText>
              <StyledText className="text-base">• 同意を得た場合に限り、マーケティングや広告メッセージの配信、アプリ内での広告表示。</StyledText>
              <StyledText className="text-base">• サービスの改善、最適化、統計分析。</StyledText>

              <StyledText className="font-bold text-lg">データの共有:</StyledText>
              <StyledText className="text-base">• NowMatchは、サービスの提供に必要な範囲で、内部の担当者、サービスプロバイダー、認証済みのパートナーとデータを共有します。</StyledText>
              ...
              <StyledText className="text-base">これらのプライバシーポリシーは、NowMatchを安全かつ快適に利用するために定められたものです。ユーザーの皆様には、プライバシーポリシーをよくお読みいただき、ご理解いただいた上でNowMatchをご利用ください。</StyledText>
            </StyledView>
          </StyledScrollView>
        </StyledView>
      </Modal>
